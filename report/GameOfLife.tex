...
\bibitem {wiki} Web, https:\slash\slash en.wikipedia.org\slash wiki\slash Conway's\_Game\_of\_Life
\bibitem {stan} Web,  http:\slash\slash web.stanford.edu\slash\~cdebs\slash GameOfLife\slash
\end{thebibliography}
\end{document}
